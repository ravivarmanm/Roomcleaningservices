            ...
            <nav id="header" class="main-header bg-light navbar navbar-expand">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown" id="notification">
                     ...
                     <li onclick="setReportModal()" class="nav-item d-none d-sm-inline-block">
                    ...
                    <li onclick="setMainContent('cleaners')" class="nav-item d-none d-sm-inline-block">
                        <a href="#" class="nav-link ">Cleaners</a>
                    </li>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li id="tab-btn-contact" class="nav-item" onclick="setMainContentFromSideBar('cleaners')">
                            <a href="#" class="nav-link">
                                <p>
                                    Cleaners
                                </p>
                        ...
                        <li id="tab-btn-contact" class="nav-item" onclick="setReportModal()">
                            <a href="#" class="nav-link">
                                <p>
                                    Report
                                </p>
            ...
            <div class="content p-3">
                <div class="container-fluid">
                    <div class="row w-100" id="tickets-container" hidden>
                         <div class="col-12">
                            <div class="card" id="cleaner-content">
                                <div class="card-header">
                                    <h3 class="card-title"  id="cleaner-content-title">Tickets</h3>
                                </div>
                   ...
                   <div class="row w-100" id="feedbacks-container" hidden>
                    ...
                    <div class="row w-100" id="services-container" hidden>
                        <div class="col-12">
                            <div class="card" id="services-content">
                                <div class="card-header">
                                    <h3 class="card-title"  id="cleaner-content-title">Services</h3>
                                </div>
                    ...
                    <div class="row w-100" id="cleaners-container" hidden>
                          <div class="col-12">
                            <div class="card" id="cleaner-content">
                                <div class="card-header">
                                    <h3 class="card-title"  id="cleaner-content-title">Cleaners</h3>
                                </div>
                                <div class="card-body"  id="cleaner-content-body">
                                </div>
                            </div>
                        </div>
                    </div>
