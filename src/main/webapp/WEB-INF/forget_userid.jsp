...
<!-- /.login-logo -->
  ...
  <div class="card-header text-center">      
      <a href="#" class="h1">Forget UserId</a>
    </div>
    ...
    <div class="card-body">
      <form action="#" method="post">
       ...
       <label>Email</label><span class="text-danger text-center"></span>
       
       <div class="input-group mb-3">
         <input required="required" type="email" class="form-control" placeholder="example@gmail.com"
            id="email" name="email"/>
            </div>
       
            <div class="col-5">
                <button  id="submit-button" onclick="userid()" type="submit" class="btn btn-primary btn-block">Check</button>
            </div>
        </div>
      </form>
      <P>${message}</P>
