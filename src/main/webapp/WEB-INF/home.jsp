...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="/cleaner_login">Cleaner Login</a>
                    </li>
                    <li>
    ...
    <section class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img class="img-responsive img-circle center-block" src="img/microphone.jpg" alt="">
                </div>
                <div class="col-sm-6">
     ...
     <section class="content content-2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <img class="img-responsive img-circle center-block" src="img/iphone.jpg" alt="">
                </div>            
    ...
    <footer class="page-footer">
        ...
        <div class="contact">
        	<div class="container">
				...
				<p><span class="glyphicon glyphicon-envelope"></span><br> info@rcs.com</p>
        	</div>
        </div>
        ...
        <div class="small-print">
        	<div class="container">
        		<p>Copyright &copy; RCS.com 2022</p>
        	</div>
        </div>
