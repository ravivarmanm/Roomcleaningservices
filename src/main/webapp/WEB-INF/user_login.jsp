...
<!-- /.login-logo -->
  <div class="card card-outline card-primary">
    ...
    <form action="" method="post">
        ...
        <input required type="text" class="form-control" placeholder="UserId"
      ...
      <p class="mb-0">
        <a href="/user_register" class="text-center">Don't have an account?</a>
      </p>
      <p class="mb-1">
        <a href="/forget_password" class="text-center">Forget password?</a>
      </p>
       <p class="mb-2">
        <a href="/forget_userid" class="text-center">Forget UserId?</a>
      </p>
